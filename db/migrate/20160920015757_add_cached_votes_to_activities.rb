class AddCachedVotesToActivities < ActiveRecord::Migration[5.0]
  def self.up
  ...
  def self.down
    remove_column :activities, :cached_votes_total
    remove_column :activities, :cached_votes_score
    remove_column :activities, :cached_votes_up
    remove_column :activities, :cached_votes_down
    remove_column :activities, :cached_weighted_score
    remove_column :activities, :cached_weighted_total
    remove_column :activities, :cached_weighted_average
  end
end
